    ...
    return (
      <div className="Search">
        <form >
            ...
            <input name="search" className="search" placeholder={"Search for a title"} type={"text"} onChange={newQuery}></input>
            <Link to={`/title/search?query=${encodeURIComponent(query)}`} state={{searchQuery: decodeURIComponent(query)}}>
